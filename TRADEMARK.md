...
The ATAH name, logo, marks, conformance badges, and official project identity are associated with the official ATAH protocol and its governance.
...
## Uses that require accuracy and clarity
...
The ATAH specification is published under Apache 2.0 and may be forked or extended in accordance with that licence. A fork or derivative work should clearly disclose its relationship to ATAH and identify any material changes from the published ATAH specification. Forks should not use names, logos, or branding likely to be confused with the official ATAH project.

## Reporting concerns

If you encounter use of the ATAH name, logo, marks, or identity that appears to misrepresent the official project, please raise it via GitHub issues or by contacting the project maintainers (see GOVERNANCE.md for contact channels).

This policy may evolve as the project matures and as the governance transition progresses. Substantive changes follow the standard governance process described in GOVERNANCE.md.

---

*This trademark and brand-use policy applies to all uses of the ATAH name, marks, and project identity. It complements the Apache 2.0 licence under which the ATAH specification is published; the licence governs use of the specification text, while this policy governs use of project identity and brand.*
